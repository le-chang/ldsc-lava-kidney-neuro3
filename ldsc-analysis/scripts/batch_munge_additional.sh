...
#SBATCH --job-name=munge_add
#SBATCH --account=def-gsarah
#SBATCH --time=20:00:00
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --array=0-13
#SBATCH --output=munge_add-%A-%a.out
#SBATCH --error=munge_add-%A-%a.err
...
# Define all combinations: 7 files × 2 configurations = 14 array tasks
SUMSTATS_FILES=(
...
BASENAME=$(basename "$SUMSTATS" | sed 's/\.(tsv|txt)$//')
