...
echo "Sample size: ${N}"
echo "A1: ${A1}, A2: ${A2}"
echo "Using --ignore N flag to ignore N column from file"
...
# Run munge_sumstats with --ignore N flag
...
ls -lh ${OUTPUT_DIR}/${OUTPUT_NAME}.sumstats.gz 2>/dev/null || echo "Warning: Output file not found"
echo "================================================"
