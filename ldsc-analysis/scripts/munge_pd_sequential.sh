...
#SBATCH --job-name=munge_lava_all
#SBATCH --output=logs/munge_lava_all_%j.out
#SBATCH --error=logs/munge_lava_all_%j.err
...
OUTPUT_DIR="/home/lchang24/scratch/ldsc_munged_longer_pd"
...
for IDX in {0..7}; do
    ...
    # Run munge_sumstats - EXACTLY like the working debug script
